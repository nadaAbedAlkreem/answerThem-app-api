                            ...
                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-primary fw-bold py-4 fs-6 w-275px" data-kt-menu="true">
                                ...
                                <div class="menu-item px-5" data-kt-menu-trigger="hover">
                                    ...
                                    <div class="menu-sub menu-sub-dropdown w-175px py-4">
                                        <!--begin::Menu item-->
                                        <div class="menu-item px-3">
                                            <a href="{{route('roles.index.lang' , ['lang' => 'en'])}}" class="menu-link d-flex px-5  @if(app()->getLocale() == 'en') active @endif">
                                        ...
                                        <!--begin::Menu item-->
                                        <div class="menu-item px-3">
                                            <a href="{{route('roles.index.lang' , ['lang' => 'ar'])}}" class="menu-link d-flex px-5  @if(app()->getLocale() == 'ar') active @endif">
                                                    <span class="symbol symbol-20px me-4">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="card mt-3">
                                                <div class="card-body">
                                                    <h4>
                                                         @can('create role')
                                                            <a href="{{ route('roles.create' ,  ['lang' => app()->getLocale()]) }}" class="btn btn-primary float-end">{{__('setting.Create')}}</a>
                                                        @endcan
                                                    </h4>
                                                </div>
                                                <div class="card-body">
