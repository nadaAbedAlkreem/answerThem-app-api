...
@section('content')
                            ...
                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-primary fw-bold py-4 fs-6 w-275px" data-kt-menu="true">
                                ...
                                <div class="menu-item px-5" data-kt-menu-trigger="hover">
                                    ...
                                    <div class="menu-sub menu-sub-dropdown w-175px py-4">
                                        <!--begin::Menu item-->
                                        <div class="menu-item px-3">
                                            <a href="{{route('permissions.index.lang' , ['lang' => 'en'])}}" class="menu-link d-flex px-5  @if(app()->getLocale() == 'en') active @endif">
                                        ...
                                        <!--begin::Menu item-->
                                        <div class="menu-item px-3">
                                            <a href="{{route('permissions.index.lang' , ['lang' => 'ar'])}}" class="menu-link d-flex px-5  @if(app()->getLocale() == 'ar') active @endif">
                                                    <span class="symbol symbol-20px me-4">
                                                ...
                                                <div class="card-body">
                                                    <h4>
                                                        @can('create permission')
                                                            <a href="{{ route('permissions.create' , ['lang' => app()->getLocale()]) }}" class="btn btn-primary float-end">{{__('setting.Create')}}</a>
                                                        @endcan
                                                    </h4>
                                                </div>
                                                <div class="card-body">
                                                    ...
                                                    <table class="data-table-permissions table  table-bordered table-striped ">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <th width="40%">{{__('setting.Actions')}}</th>
                                                        </tr>
                                                        </thead>
                                                        <tbody>
    ...
    <!-- in this page  -->
    <script src="{{asset('assets/js/custom/actions/permissions-action.js')}}"></script>
