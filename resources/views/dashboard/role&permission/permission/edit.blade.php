            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form id="formUpdatePermission">
                        @csrf
                        @method('PUT')
                        <input type="hidden" name="id" id="id" value="{{ $permission->id }}" class="form-control" />
                        ...
                        <div class="mb-3">
                            <button type="submit" id="submitPermission" class="btn btn-primary">{{__('setting.Update')}}</button>
                        </div>
                    </form>
                </div>
            </div>
