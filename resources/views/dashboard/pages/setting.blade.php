...
@section('content')
                        ...
                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-primary fw-bold py-4 fs-6 w-275px" data-kt-menu="true">
                            ...
                            <div class="menu-item px-5" data-kt-menu-trigger="hover" >
                                ...
                                <div class="menu-sub menu-sub-dropdown w-175px py-4"  >
                                    <!-- Menu item: English -->
                                    <div class="menu-item px-3">
                                        <a href="{{ route('dashboard.setting', ['lang' => 'en']) }}"
                                    ...
                                    <!-- Menu item: Arabic -->
                                    <div class="menu-item px-3" >
                                        <a href="{{ route('dashboard.setting', ['lang' => 'ar']) }}"
            ...
            <div class="wrapper d-flex flex-column flex-row-fluid container-xxl" id="kt_wrapper">
                ...
                <div class="toolbar d-flex flex-stack flex-wrap py-4 gap-2" id="kt_toolbar">
                    ...
                    <div class="page-title d-flex flex-column align-items-start me-3 gap-1">
                        <!--begin::Title-->
                        <h1 class="d-flex text-dark fw-bolder m-0 fs-3">{{__('setting.Project Settings')}}</h1>
                        <!--end::Title-->
                    ...
                    <div class="content flex-row-fluid" id="kt_content">
                        ...
                        <div class="card mb-9">
                            <div class="card-body pt-9 pb-0">
                                        ...
                                        <div class="d-flex justify-content-between align-items-start flex-wrap mb-2"  style="padding:5px">
                                            ...
                                            <div class="d-flex flex-column">
                                                ...
                                                <div class="d-flex align-items-center mb-1">
                                                    <a href="#" class="text-gray-800 text-hover-primary fs-2 fw-bolder me-3">{{__('setting.gaweb7om app')}}</a>
                                                    <span class="badge badge-light-success me-auto">{{__('setting.In Progress')}}</span>
                                                </div>
                                                <!--end::Status-->
                                                <!--begin::Description-->
                                                <div class="d-flex flex-wrap fw-bold mb-4 fs-5 text-gray-400">{{__('setting.Answer them game application, a competition on a set of questions')}}</div>
                                                <!--end::Description-->
                                            </div>
                                ...
                                <ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bolder">
                                    <li class="nav-item">
                                        <a class="nav-link text-active-primary py-5 me-6 active" >{{__('setting.setting')}}</a>
                                    </li>
                                    <!--end::Nav item-->
                                </ul>
                                <!--end::Nav-->
                        ...
                        <div class="card">
                            ...
                            <div class="card-header">
                                <!--begin::Card title-->
                                <div class="card-title fs-3 fw-bolder">{{__('setting.Project Settings')}}</div>
                                <!--end::Card title-->
                            </div>
                            <!--end::Card header-->
                            <!--begin::Form-->
                            <form id="kt_project_settings_form" class="form"  enctype="multipart/form-data" >
                                        ...
                                        @foreach($settings as $setting)
                                            @switch($setting->type)
                                                @case('string')
                                                    ...
                                                    <div class="row mb-8">
                                                        <div class="col-xl-3">
                                                            <label class="fs-6 fw-bold mt-2 mb-3">{{__('setting.app name')}}</label>
                                                        </div>
                                                        ...
                                                        <div class="col-lg-8">
                                                            ...
                                                            <div class="image-input image-input-outline" data-kt-image-input="true" style="background-image: url('assets/media/svg/avatars/blank.svg')">
                                                                ...
                                                                <label class="btn btn-icon btn-circle btn-active-color-primary w-25px h-25px bg-white shadow" data-kt-image-input-action="change" data-bs-toggle="tooltip" title="{{__('setting.Change avatar')}}">
                                                                    ...
                                                                    <input type="hidden" name="{{__('setting.avatar_remove')}}" />
                                                                    <!--end::Inputs-->
                                                                </label>
                                                                <!--end::Label-->
                                                                <!--begin::Cancel-->
                                                                ...
                                                                <div class="card shadow-lg border-0 rounded-3 hover-shadow-lg transition-all">
                                                                    ...
                                                                    <div class="card-body">
                                                                        ...
                                                                        @if(!empty($json['image']))
                                                                            ...
                                                                            <div class="row mb-5">
                                                                                ...
                                                                                <label class="form-label fw-bold text-dark">
                                                                                    <i class="bi bi-image-fill me-2"></i>{{__('setting.Image')}}
                                                                                </label>
                                                                                <!--end::Col-->
                                                                                <!--begin::Col-->
                                                                                <div class="col-lg-8">
                                                                        ...
                                                                        @if(!empty($json['title']))
                                                                            <div class="mb-4">
                                                                                <label class="form-label fw-bold text-dark">
                                                                                    <i class="bi bi-fonts me-2"></i>{{__('setting.Title')}}
                                                                                </label>
                                                                        ...
                                                                        @if(!empty($json['body']))
                                                                            <div class="mb-4">
                                                                                <label class="form-label fw-bold text-dark">
                                                                                    <i class="bi bi-textarea-t me-2"></i>{{__('setting.Body')}}
                                                                                </label>
                                                                        ...
                                                                        @if($setting->base_term == 'app terms and conditions')
                                                                            <div class="mb-4">
                                                                                <label class="form-label fw-bold text-dark">
                                                                                    <i class="bi bi-globe me-2"></i>
                                                                                    {{__('setting.app terms and conditions')}}
                                                                                </label>
                                                                                <input type="text" class="form-control rounded-3 shadow-sm" name="{{$setting->id}}-{{$index}}" value="{{$json}}" placeholder="Enter contact us " required />
                                                                        ...
                                                                        @if($setting->base_term == 'problem suggestions')
                                                                            <div class="mb-4">
                                                                                <label class="form-label fw-bold text-dark">
                                                                                    <i class="bi bi-globe me-2"></i>
                                                                                    {{__('setting.problem suggestions')}}
                                                                                </label>
                                                                                <input type="text" class="form-control rounded-3 shadow-sm" name="{{$setting->id}}-{{$index}}" value="{{$json}}" placeholder="Enter contact us " required />
                                ...
                                <div class="card-footer d-flex justify-content-end py-6 px-9">
                                    <button type="reset" class="btn btn-light btn-active-light-primary me-2">{{__('setting.Discard')}}</button>
                                    <button type="submit" id="setting_form" class="btn btn-primary">{{__('setting.Save Changes')}}</button>
                                </div>
                                <!--end::Card footer-->
                            </form>
                            <!--end:Form-->
    ...
    <script>
        ...
        window.translations = {
            success_message: @json(__('setting.Successfully_updated_changes')),
