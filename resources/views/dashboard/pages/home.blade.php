                    ...
                    <div class="menu menu-column menu-lg-row menu-active-bg menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500 fw-bold my-5 my-lg-0 align-items-stretch flex-grow-1" id="kt_header_menu" data-kt-menu="true">
                        <div data-kt-menu-trigger="click" data-kt-menu-placement="bottom-start" class="menu-item here show menu-lg-down-accordion me-lg-1">
                            ...
                            <div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-rounded-0 py-lg-4 w-lg-225px">
                                ...
                                <div class="menu-item">
                                    <a class="menu-link active py-3" href="../../demo19/dist/dashboards/ecommerce.html">
												<span class="menu-bullet">
													<span class="bullet bullet-dot"></span>
												</span>
                        ...
                        <div data-kt-menu-trigger="click" data-kt-menu-placement="bottom-start" class="menu-item menu-lg-down-accordion me-lg-1">
                            ...
                            <div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-rounded-0 py-lg-4 w-lg-225px">
                                <div class="menu-item">
                                    <a class="menu-link py-3" href="{{route('dashboard.setting.create')}}" title="Check out over 200 in-house components, plugins and ready for use solutions" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss="click" data-bs-placement="right">
        ...
        <div class="wrapper d-flex flex-column flex-row-fluid container-xxl" id="kt_wrapper">
            ...
            <div class="toolbar d-flex flex-stack flex-wrap py-4 gap-2" id="kt_toolbar">
                ...
                <div class="page-title d-flex flex-column align-items-start me-3 gap-1">
                    <!--begin::Title-->
                    <h1 class="d-flex text-dark fw-bolder m-0 fs-3">eCommerce Dashboard</h1>
                    <!--end::Title-->
                </div>
                <!--end::Page title-->
                <!--begin::Actions-->
                <div class="d-flex align-items-center py-1">
                    ...
                    <div class="me-2">
                        ...
                        <!--begin::Menu 1-->
                        <div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_61cf14ec4c037">
                            <!--begin::Header-->
                            <div class="px-7 py-5">
                            ...
                            <div class="px-7 py-5">
                                ...
                                <div class="mb-10">
                                    ...
                                    <!--begin::Input-->
                                    <div>
                                        <select class="form-select form-select-solid" data-kt-select2="true" data-placeholder="Select option" data-dropdown-parent="#kt_menu_61cf14ec4c037" data-allow-clear="true">
                                            <option></option>
                    ...
                    <!--end::Filter-->
                    <!--begin::Button-->
                    <a href="apps/ecommerce/catalog/add-product" class="btn btn-sm btn-info" id="kt_toolbar_primary_button">Add Product</a>
                    <!--end::Button-->
                </div>
                <!--end::Actions-->
            </div>
                            ...
                            <div class="card card-flush overflow-hidden h-md-100">
                                ...
                                <div class="card-header py-5">
                                    ...
                                    <div class="card-toolbar">
                                        <a href="../../demo19/dist/apps/ecommerce/catalog/products.html" class="btn btn-sm btn-light-primary fw-bolder">Launch eCommerce App</a>
                                    </div>
                                    <!--end::Toolbar-->
                                </div>
                                <!--end::Header-->
                                            ...
                                            <div class="table-responsive">
                                                ...
                                                <table class="table table-row-dashed align-middle gs-0 gy-4 my-0">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="ps-0">
                                                            <a href="../../demo19/dist/apps/ecommerce/catalog/edit-product.html" class="text-gray-800 fw-bolder text-hover-primary mb-1 fs-6 text-start pe-0">Elephant 1802</a>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="ps-0">
                                                            <a href="../../demo19/dist/apps/ecommerce/catalog/edit-product.html" class="text-gray-800 fw-bolder text-hover-primary mb-1 fs-6 text-start pe-0">Red Laga</a>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="ps-0">
                                                            <a href="../../demo19/dist/apps/ecommerce/catalog/edit-product.html" class="text-gray-800 fw-bolder text-hover-primary mb-1 fs-6 text-start pe-0">RiseUP</a>
                                            ...
                                            <div class="table-responsive">
                                                ...
                                                <table class="table table-row-dashed align-middle gs-0 gy-4 my-0">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="ps-0">
                                                            <a href="../../demo19/dist/apps/ecommerce/catalog/edit-product.html" class="text-gray-800 fw-bolder text-hover-primary mb-1 fs-6 text-start pe-0">Elephant 1324</a>
                                            ...
                                            <div class="table-responsive">
                                                ...
                                                <table class="table table-row-dashed align-middle gs-0 gy-4 my-0">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="ps-0">
                                                            <a href="../../demo19/dist/apps/ecommerce/catalog/edit-product.html" class="text-gray-800 fw-bolder text-hover-primary mb-1 fs-6 text-start pe-0">Elephant 2635</a>
                                                            <span class="text-gray-400 fw-bold fs-7 d-block text-start ps-0">Item: #XDG-1523</span>
                                                        </td>
                                                        <td>
                                                            <span class="text-gray-800 fw-bolder d-block fs-6 ps-0 text-end">x1</span>
                                            ...
                                            <div class="table-responsive">
                                                ...
                                                <table class="table table-row-dashed align-middle gs-0 gy-4 my-0">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="ps-0">
                                                            <a href="../../demo19/dist/apps/ecommerce/catalog/edit-product.html" class="text-gray-800 fw-bolder text-hover-primary mb-1 fs-6 text-start pe-0">Nike</a>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="ps-0">
                                                            <a href="../../demo19/dist/apps/ecommerce/catalog/edit-product.html" class="text-gray-800 fw-bolder text-hover-primary mb-1 fs-6 text-start pe-0">Adidas</a>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="ps-0">
                                                            <a href="../../demo19/dist/apps/ecommerce/catalog/edit-product.html" class="text-gray-800 fw-bolder text-hover-primary mb-1 fs-6 text-start pe-0">Puma</a>
                            ...
                            <div class="card h-md-100">
                                ...
                                <div class="card-body d-flex flex-column flex-center">
                                    ...
                                    <div class="text-center">
                                        <!--begin::Link-->
                                        <a class="btn btn-sm btn-primary me-2" href="../../demo19/dist/apps/ecommerce/sales/listing.html">View App</a>
                                        <!--end::Link-->
                                        <!--begin::Link-->
                                        <a class="btn btn-sm btn-light" href="../../demo19/dist/apps/ecommerce/catalog/add-product.html">New Product</a>
                                        <!--end::Link-->
                                    </div>
                                    <!--end::Links-->
                                </div>
                            ...
                            <div class="card card-flush h-xl-100">
                                ...
                                <div class="card-body">
                                    ...
                                    <table class="table align-middle table-row-dashed fs-6 gy-3" id="kt_table_widget_4_table">
                                        ...
                                        <tr>
                                            <td>
                                                <a href="../../demo19/dist/apps/ecommerce/catalog/edit-product.html" class="text-dark text-hover-primary">#XGT-346</a>
                                            </td>
                                            <td class="text-end">31 December 2021, 2:34 pm</td>
                                            <td class="text-end">
                                        ...
                                        <tr>
                                            <td>
                                                <a href="../../demo19/dist/apps/ecommerce/catalog/edit-product.html" class="text-dark text-hover-primary">#YHD-047</a>
                                            </td>
                                        ...
                                        <tr>
                                            <td>
                                                <a href="../../demo19/dist/apps/ecommerce/catalog/edit-product.html" class="text-dark text-hover-primary">#SRR-678</a>
                                            </td>
                                            <td class="text-end">31 December 2021, 10:34 am</td>
                                            <td class="text-end">
                                        ...
                                        <tr>
                                            <td>
                                                <a href="../../demo19/dist/apps/ecommerce/catalog/edit-product.html" class="text-dark text-hover-primary">#PXF-534</a>
                                            </td>
                                            <td class="text-end">30 December 2021, 2:34 pm</td>
                                            <td class="text-end">
                                        ...
                                        <tr>
                                            <td>
                                                <a href="../../demo19/dist/apps/ecommerce/catalog/edit-product.html" class="text-dark text-hover-primary">#XGD-249</a>
                                            </td>
                                            <td class="text-end">29 December 2021, 2:34 pm</td>
                                            <td class="text-end">
                                        ...
                                        <tr>
                                            <td>
                                                <a href="../../demo19/dist/apps/ecommerce/catalog/edit-product.html" class="text-dark text-hover-primary">#SKP-035</a>
                                            </td>
                                            <td class="text-end">28 December 2021, 2:34 pm</td>
                                            <td class="text-end">
                                                <a href="" class="text-dark text-hover-primary">Brian Cox</a>
                                            </td>
                                        ...
                                        <tr>
                                            <td>
                                                <a href="../../demo19/dist/apps/ecommerce/catalog/edit-product.html" class="text-dark text-hover-primary">#SKP-567</a>
                                            </td>
                                            <td class="text-end">25 December 2021, 2:34 pm</td>
                                            <td class="text-end">
                                    ...
                                    <div class="hover-scroll-overlay-y pe-6 me-n6" style="height: 415px">
                                        ...
                                        <div class="rounded border-gray-300 border-1 border-gray-300 border-dashed px-7 py-3 mb-6">
                                            ...
                                            <div class="d-flex flex-stack mb-3">
                                                ...
                                                <div class="me-3">
                                                    ...
                                                    <!--end::Icon-->
                                                    <!--begin::Title-->
                                                    <a href="../../demo19/dist/apps/ecommerce/catalog/edit-product.html" class="text-gray-800 text-hover-primary fw-bolder">Elephant 1802</a>
                                                    <!--end::Title-->
                                                </div>
                                                <!--end::Wrapper-->
                                                <!--begin::Action-->
                                            ...
                                            <div class="d-flex flex-stack">
                                                ...
                                                <span class="text-gray-400 fw-bolder">To:
														<a href="../../demo19/dist/apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bolder">Jason Bourne</a></span>
                                                <!--end::Name-->
                                                <!--begin::Label-->
                                        ...
                                        <div class="rounded border-gray-300 border-1 border-gray-300 border-dashed px-7 py-3 mb-6">
                                            ...
                                            <div class="d-flex flex-stack mb-3">
                                                ...
                                                <div class="me-3">
                                                    ...
                                                    <!--end::Icon-->
                                                    <!--begin::Title-->
                                                    <a href="../../demo19/dist/apps/ecommerce/catalog/edit-product.html" class="text-gray-800 text-hover-primary fw-bolder">RiseUP</a>
                                                    <!--end::Title-->
                                                </div>
                                                <!--end::Wrapper-->
                                                <!--begin::Action-->
                                            ...
                                            <div class="d-flex flex-stack">
                                                <!--begin::Name-->
                                                <span class="text-gray-400 fw-bolder">To:
														<a href="../../demo19/dist/apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bolder">Marie Durant</a></span>
                                                <!--end::Name-->
                                                <!--begin::Label-->
                                        ...
                                        <div class="rounded border-gray-300 border-1 border-gray-300 border-dashed px-7 py-3 mb-6">
                                            ...
                                            <div class="d-flex flex-stack mb-3">
                                                ...
                                                <div class="me-3">
                                                    ...
                                                    <!--end::Icon-->
                                                    <!--begin::Title-->
                                                    <a href="../../demo19/dist/apps/ecommerce/catalog/edit-product.html" class="text-gray-800 text-hover-primary fw-bolder">Yellow Stone</a>
                                                    <!--end::Title-->
                                                </div>
                                                <!--end::Wrapper-->
                                                <!--begin::Action-->
                                            ...
                                            <div class="d-flex flex-stack">
                                                <!--begin::Name-->
                                                <span class="text-gray-400 fw-bolder">To:
														<a href="../../demo19/dist/apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bolder">Dan Wilson</a></span>
                                                <!--end::Name-->
                                                <!--begin::Label-->
                                        ...
                                        <div class="rounded border-gray-300 border-1 border-gray-300 border-dashed px-7 py-3 mb-6">
                                            ...
                                            <div class="d-flex flex-stack">
                                                <!--begin::Name-->
                                                <span class="text-gray-400 fw-bolder">To:
														<a href="../../demo19/dist/apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bolder">Lebron Wayde</a></span>
                                                <!--end::Name-->
                                                <!--begin::Label-->
                                                <span class="badge badge-light-success">Delivered</span>
                                                <!--end::Label-->
                                        ...
                                        <div class="rounded border-gray-300 border-1 border-gray-300 border-dashed px-7 py-3 mb-6">
                                            ...
                                            <div class="d-flex flex-stack">
                                                <!--begin::Name-->
                                                <span class="text-gray-400 fw-bolder">To:
														<a href="../../demo19/dist/apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bolder">Ana Simmons</a></span>
                                                <!--end::Name-->
                                                <!--begin::Label-->
                                                <span class="badge badge-light-primary">Shipping</span>
                                                <!--end::Label-->
                                        ...
                                        <div class="rounded border-gray-300 border-1 border-gray-300 border-dashed px-7 py-3">
                                            ...
                                            <div class="d-flex flex-stack">
                                                <!--begin::Name-->
                                                <span class="text-gray-400 fw-bolder">To:
														<a href="../../demo19/dist/apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bolder">Kevin Leonard</a></span>
                                                <!--end::Name-->
                                                <!--begin::Label-->
                                                <span class="badge badge-light-danger">Confirmed</span>
                                                <!--end::Label-->
                                ...
                                <div class="card-body">
                                    ...
                                    <table class="table align-middle table-row-dashed fs-6 gy-3" id="kt_table_widget_5_table">
                                        ...
                                        <tr>
                                            ...
                                            <!--end::Product ID-->
                                            <!--begin::Date added-->
                                            <td class="text-end">Nov 10, 2021</td>
                                            <!--end::Date added-->
                                            <!--begin::Price-->
                                        ...
                                        <tr>
                                            ...
                                            <!--end::Product ID-->
                                            <!--begin::Date added-->
                                            <td class="text-end">Jun 20, 2021</td>
                                            <!--end::Date added-->
                                            <!--begin::Price-->
                                            <td class="text-end">$1,060</td>
                                            <!--end::Price-->
                                        ...
                                        <tr>
                                            ...
                                            <!--end::Product ID-->
                                            <!--begin::Date added-->
                                            <td class="text-end">Mar 10, 2021</td>
                                            <!--end::Date added-->
                                            <!--begin::Price-->
                                        ...
                                        <tr>
                                            ...
                                            <!--end::Product ID-->
                                            <!--begin::Date added-->
                                            <td class="text-end">Jun 24, 2021</td>
                                            <!--end::Date added-->
                                            <!--begin::Price-->
                                            <td class="text-end">$1,060</td>
                                            <!--end::Price-->
                                        ...
                                        <tr>
                                            ...
                                            <!--end::Product ID-->
                                            <!--begin::Date added-->
                                            <td class="text-end">Apr 15, 2021</td>
                                            <!--end::Date added-->
                                            <!--begin::Price-->
                                            <td class="text-end">$1,060</td>
                                            <!--end::Price-->
