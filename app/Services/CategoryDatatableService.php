...
//                                                                    </svg>
                                                 ...
                                                 <a  class="btn btn-icon btn-color-gray-400 btn-sm btn-active-color-primary create-category updateRecord" data-bs-toggle="modal" data-bs-target="#kt_modal_update_app"  data-famous_gaming="' . $data['famous_gaming']. '"  data-id="' . $data['id']. '"  data-name_ar="' . $data['name_ar']. '" data-name_en="' . $data['name_en']. '"  data-description_ar="' . $data['description_ar']. '"  data-description_en="' . $data['description_en']. '"  data-rating="' .$data['rating']. '"  data-level="' .$data['level']. '"  data-category_id="' .$data['parent_id']. '"  data-image="' .$data['image']. '"  data-bs-toggle="tooltip" data-bs-placement="right" title="Mark as important">
                                                     <span class="svg-icon svg-icon-3 mt-1">
