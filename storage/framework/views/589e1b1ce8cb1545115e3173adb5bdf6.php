                            ...
                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-primary fw-bold py-4 fs-6 w-275px" data-kt-menu="true">
                                ...
                                <div class="menu-item px-5" data-kt-menu-trigger="hover">
                                    ...
                                    <div class="menu-sub menu-sub-dropdown w-175px py-4">
                                        <!--begin::Menu item-->
                                        <div class="menu-item px-3">
                                            <a href="<?php echo e(route('dashboard.users' , ['lang' => 'en'])); ?>" class="menu-link d-flex px-5  <?php if(app()->getLocale() == 'en'): ?> active <?php endif; ?>">
                                        ...
                                        <!--begin::Menu item-->
                                        <div class="menu-item px-3">
                                            <a href="<?php echo e(route('dashboard.users' , ['lang' => 'ar'])); ?>" class="menu-link d-flex px-5  <?php if(app()->getLocale() == 'ar'): ?> active <?php endif; ?>">
												<span class="symbol symbol-20px me-4">
                                    ...
                                    <div class="card-body p-2">
                                        ...
                                        <table class="table data-users table-hover table-row-dashed fs-6 gy-5 my-0" id="kt_inbox_listing">
                                            ...
                                            <tr>
                                                ...
                                                <th><?php echo e(__('setting.Country')); ?></th>
                                            </tr>
                                            </thead>
                                            <!--end::Table head-->
                                            <!--begin::Table body-->
