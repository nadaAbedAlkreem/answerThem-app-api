        ...
        <div class="wrapper d-flex flex-column flex-row-fluid container-xxl" id="kt_wrapper">
            ...
            <div class="toolbar d-flex flex-stack flex-wrap py-4 gap-2" id="kt_toolbar">
                ...
                <div class="page-title d-flex flex-column align-items-start me-3 gap-1">
                    <!--begin::Title-->
                    <h1 class="d-flex text-dark fw-bolder m-0 fs-3">Dashboard</h1>
                    <!--end::Title-->
                </div>
                <!--end::Page title-->
                        ...
                        <div class="col-md-6 col-lg-6 col-xl-6 col-xxl-3 mb-md-5 mb-xl-10">
                            ...
                            <div class="card card-flush h-md-50 mb-5 mb-xl-10">
                                ...
                                <div class="card-body pt-2 pb-4 d-flex align-items-center">
                                    ...
                                    <?php $__currentLoopData = $ratingsByEvaluation; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $evaluation): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <!--begin::Labels-->
                                                    <div class="d-flex flex-column align-items-start">
                                                        ...
                                                        <div class="d-flex flex-column fs-6 fw-bold text-start">
                                                            <!--begin::Bullet-->
                                                             <!--end::Bullet-->
                                                            <!--begin::Label-->
                                                            <div class="text-gray-500 pe-1"><?php echo e($evaluation->descriptive_evaluation); ?></div>
                                                            <!--end::Label-->
                                                            <!--begin::Stats-->
                                                            <div class="fw-boldest text-gray-700 mt-1"><?php echo e($evaluation->count); ?></div>
                                                            <!--end::Stats-->
                                                        </div>
                                                        <!--end::Label-->
                                                    </div>
                                 ...
                                 <div class="card-body pt-2 pb-4 d-flex align-items-center">
                                    ...
                                    <div class="vertical-labels">
                                        <div class="item">
                                            ...
                                            <?php $__currentLoopData = $categoryByLevel; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <!--begin::Labels-->
                                                <div class="d-flex flex-column align-items-start">
                                                    <!--begin::Label-->
                                                    <div class="d-flex flex-column fs-6 fw-bold text-start">
                                                        ...
                                                        <!--end::Bullet-->
                                                        <!--begin::Label-->
                                                        <div class="text-gray-500 pe-1"><?php echo e($category->level); ?></div>
                                                        <!--end::Label-->
                                                        <!--begin::Stats-->
                                                        <div class="fw-boldest text-gray-700 mt-1"><?php echo e($category->count); ?></div>
                                                        <!--end::Stats-->
                                                    </div>
                                                    <!--end::Label-->
                                                </div>
                            ...
                            <div class="card card-flush overflow-hidden h-md-100">
                                ...
                                <div class="card-header py-5">
                                    ...
                                    <h3 class="card-title align-items-start flex-column">
                                        <span class="card-label fw-bolder text-dark">Challenges Created This Year</span>
                                        <span class="text-gray-400 mt-1 fw-bold fs-6">Monthly Challenge Analysis</span>
                                ...
                                <div class="card-body d-flex justify-content-between flex-column pb-1 px-0">
                                    ...
                                    <div class="px-9 mb-5">
                                        ...
                                        <div class="d-flex mb-2">
                                             <span class="fs-2hx fw-bolder text-gray-800 me-2 lh-1">Challenges</span>
                                        </div>
                                        <!--end::Statistics-->
                                        <!--begin::Description-->
                                        <span class="fs-6 fw-bold text-gray-400">Track user engagement to start competitive rounds on the app</span>
                                        <!--end::Description-->
                                    </div>
                                    <!--end::Statistics-->
                                    <!--begin::Chart-->
                        ...
                        <div class="col-lg-12 col-xl-12 col-xxl-6 mb-5 mb-xl-0">
                            ...
                            <div class="card card-flush overflow-hidden h-md-100">
                                ...
                                <div class="card-header py-5">
                                    <!--begin::Title-->
                                    <h3 class="card-title align-items-start flex-column">
                                        <span class="card-label fw-bolder text-dark">User Created This Year</span>
                                        <span class="text-gray-400 mt-1 fw-bold fs-6">Monthly Create User Account  Analysis</span>
                                ...
                                <div class="card-body d-flex justify-content-between flex-column pb-1 px-0">
                                    ...
                                    <div class="px-9 mb-5">
                                        <!--begin::Statistics-->
                                        <div class="d-flex mb-2">
                                            <span class="fs-2hx fw-bolder text-gray-800 me-2 lh-1">Create User Account</span>
                                        </div>
                                        <!--end::Statistics-->
                                        <!--begin::Description-->
                                        <span class="fs-6 fw-bold text-gray-400">Track the number of times an account is created on an app during a month throughout the year</span>
                                        <!--end::Description-->
                                    </div>
                                    <!--end::Statistics-->
                                    <!--begin::Chart-->
