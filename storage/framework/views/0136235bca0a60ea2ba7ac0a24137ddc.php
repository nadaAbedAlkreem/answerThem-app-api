                            ...
                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-primary fw-bold py-4 fs-6 w-275px" data-kt-menu="true">
                                ...
                                <div class="menu-item px-5" data-kt-menu-trigger="hover">
                                    ...
                                    <div class="menu-sub menu-sub-dropdown w-175px py-4">
                                        <!--begin::Menu item-->
                                        <div class="menu-item px-3">
                                            <a href="<?php echo e(route('roles.index.lang' , ['lang' => 'en'])); ?>" class="menu-link d-flex px-5  <?php if(app()->getLocale() == 'en'): ?> active <?php endif; ?>">
                                        ...
                                        <!--begin::Menu item-->
                                        <div class="menu-item px-3">
                                            <a href="<?php echo e(route('roles.index.lang' , ['lang' => 'ar'])); ?>" class="menu-link d-flex px-5  <?php if(app()->getLocale() == 'ar'): ?> active <?php endif; ?>">
                                                    <span class="symbol symbol-20px me-4">
                                                ...
                                                <div class="card-body">
                                                    <h4>
                                                         <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create role')): ?>
                                                            <a href="<?php echo e(route('roles.create' ,  ['lang' => app()->getLocale()])); ?>" class="btn btn-primary float-end"><?php echo e(__('setting.Create')); ?></a>
                                                        <?php endif; ?>
                                                    </h4>
                                                </div>
                                                <div class="card-body">
