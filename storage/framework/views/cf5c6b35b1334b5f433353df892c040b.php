                        ...
                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-primary fw-bold py-4 fs-6 w-275px" data-kt-menu="true">
                            ...
                            <div class="menu-item px-5" data-kt-menu-trigger="hover">
                                ...
                                <div class="menu-sub menu-sub-dropdown w-175px py-4">
                                    <!--begin::Menu item-->
                                    <div class="menu-item px-3">
                                        <a href="<?php echo e(route('dashboard.category' , ['lang' => 'en'])); ?>" class="menu-link d-flex px-5  <?php if(app()->getLocale() == 'en'): ?> active <?php endif; ?>">
                                    ...
                                    <!--begin::Menu item-->
                                    <div class="menu-item px-3">
                                        <a href="<?php echo e(route('dashboard.category' , ['lang' => 'ar'])); ?>" class="menu-link d-flex px-5  <?php if(app()->getLocale() == 'ar'): ?> active <?php endif; ?>">
												<span class="symbol symbol-20px me-4">
                    ...
                    <div class="me-2">
                        ...
                        <div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_61cf14c9caa9b">
                            ...
                            <div class="px-7 py-5">
                                ...
                                <div class="mb-10">
                                    <!--begin::Label-->
                                    <label class="form-label fw-bold"><?php echo e(__('setting.Show dependencies :')); ?></label>
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <div>
                                        <select id="categorySelect" name="categorySelect" data-kt-select2="true" data-placeholder="<?php echo e(__('setting.Select a category')); ?>" data-dropdown-parent="#kt_menu_61cf14c9caa9b" data-allow-clear="true" style="width: 100%"></select>
                                    </div>
                                ...
                                <div class="card-body p-2">
                                    ...
                                    <table class="table data-table-category table-bordered table-striped table-hover table-row-dashed fs-6 gy-5 my-0">
                                        ...
                                        <tr>
                                            ...
                                            <th><?php echo e(__('setting.Rating')); ?></th>
                                            <th><?php echo e(__('setting.Famous gaming')); ?></th>
    ...
    <div class="modal-dialog modal-dialog-centered mw-900px">
        ...
        <div class="modal-content">
            ...
            <div class="modal-header">
                <!--begin::Modal title-->
                <h2><?php echo e(__('setting.Create Category')); ?></h2>
                <!--end::Modal title-->
                <!--begin::Close-->
                        ...
                        <div class="stepper-nav ps-lg-10">
                            ...
                            <div class="stepper-item current" data-kt-stepper-element="nav">
                                ...
                                <div class="stepper-label">
                                    <h3 class="stepper-title"><?php echo e(__('setting.Details')); ?></h3>
                                    <div class="stepper-desc"><?php echo e(__('setting.Name Category')); ?></div>
                                </div>
                                <!--end::Label-->
                            </div>
                            <!--end::Step 1-->
                            ...
                            <div class="stepper-item" data-kt-stepper-element="nav">
                                ...
                                <div class="stepper-label">
                                    <h3 class="stepper-title"><?php echo e(__('setting.Details')); ?></h3>
                                    <div class="stepper-desc"><?php echo e(__('setting.Description Category')); ?></div>
                                </div>
                                <!--end::Label-->
                            ...
                            <div class="stepper-item" data-kt-stepper-element="nav">
                                ...
                                <div class="stepper-label">
                                    ...
                                    <div class="stepper-desc"><?php echo e(__('setting.Define profile picture and category affiliation')); ?></div>
                                </div>
                                <!--end::Label-->
                            </div>
                            <!--end::Step 3-->
                            ...
                            <div class="stepper-item" data-kt-stepper-element="nav">
                                ...
                                <!--begin::Label-->
                                <div class="stepper-label">
                                    <h3 class="stepper-title"><?php echo e(__('setting.Evaluation')); ?></h3>
                                    <div class="stepper-desc"><?php echo e(__('setting.Determine category distinction')); ?></div>
                                </div>
                                <!--end::Label-->
                            </div>
                            <!--end::Step 4-->
                            ...
                            <div class="current" data-kt-stepper-element="content">
                                <div class="w-100">
                                    ...
                                    <div class="fv-row mb-10">
                                        ...
                                        <!--end::Label-->
                                        <!--begin::Input-->
                                        <input type="text" class="form-control form-control-lg form-control-solid" name="name_ar" placeholder="<?php echo e(__('setting.Category Name Arabic')); ?>" value="" />
                                        <!--end::Input-->
                                    </div>
                                    <!--end::Input group-->
                                    ...
                                    <div class="w-100">
                                        ...
                                        <div class="fv-row mb-10">
                                            ...
                                            <!--end::Label-->
                                            <!--begin::Input-->
                                            <input type="text" class="form-control form-control-lg form-control-solid" name="name_en" placeholder="<?php echo e(__('setting.Category Name English')); ?>" value="" />
                                            <!--end::Input-->
                                        </div>
                                        <!--end::Input group-->
                                    </div>
                            ...
                            <div data-kt-stepper-element="content">
                                <div class="w-100">
                                    <div class="fv-row mb-10">
                                        <!--begin::Label-->
                                        <label class="d-flex align-items-center fs-5 fw-bold mb-2">
                                            <span class="required"><?php echo e(__('setting.Category Description Arabic')); ?></span>
                                            <i class="fas fa-exclamation-circle ms-2 fs-7" data-bs-toggle="tooltip" title="<?php echo e(__('setting.Specify your unique app name')); ?>"></i>
                                        </label>
                                        <!--end::Label-->
                                        <!--begin::Input-->
                                        <div class="mb-4">
                                            <textarea class="form-control form-control-lg form-control-solid rounded-3 shadow-sm" name="description_ar" rows="4" placeholder="<?php echo e(__('setting.Category Description Arabic')); ?>" required></textarea>
                                        </div>                                        <!--end::Input-->
                                    </div>
                                    ...
                                    <div class="fv-row mb-10">
                                        <!--begin::Label-->
                                        <label class="d-flex align-items-center fs-5 fw-bold mb-2">
                                            <span class="required"><?php echo e(__('setting.Category Description English')); ?></span>
                                            <i class="fas fa-exclamation-circle ms-2 fs-7" data-bs-toggle="tooltip" title="<?php echo e(__('setting.Specify your unique app name')); ?>"></i>
                                        </label>
                                        <!--end::Label-->
                                        <!--begin::Input-->
                                        <div class="mb-4">
                                            <textarea class="form-control form-control-lg form-control-solid rounded-3 shadow-sm" name="description_en" rows="4" placeholder="<?php echo e(__('setting.Category Description English')); ?>" required></textarea>
                                        </div>                                        <!--end::Input-->
                                    </div>
                            ...
                            <div data-kt-stepper-element="content">
                                <div class="w-100">
                                    ...
                                    <div class="fv-row mb-10">
                                        ...
                                        <!--end::Label-->
                                        <!--begin::Input-->
                                        <label for="rating" class="required fs-5 fw-bold mb-2"><?php echo e(__('setting.Rating')); ?>:</label>
                                    ...
                                    <div class="fv-row">
                                        <!--begin::Label-->
                                        <label class="d-flex align-items-center fs-5 fw-bold mb-4">
                                            <span class="required"><?php echo e(__('setting.Famous gaming')); ?></span>
                                            <i class="fas fa-exclamation-circle ms-2 fs-7" data-bs-toggle="tooltip" title="<?php echo e(__('setting.Select your app database engine')); ?>"></i>
                                        </label>
        ...
        <div class="modal-dialog modal-dialog-centered mw-900px">
            ...
            <div class="modal-content">
                ...
                <div class="modal-header">
                    ...
                    <h2><?php echo e(__('setting.Update Category')); ?></h2>
                    <!--نهاية عنوان النافذة المنبثقة-->
                    <!--بداية زر الإغلاق-->
                    <input type="hidden" id="id" class="form-control" value="" placeholder="<?php echo e(__('setting.Item ID will appear here')); ?>">
                        ...
                        <div class="d-flex justify-content-center justify-content-xl-start flex-row-auto w-100 w-xl-300px">
                            ...
                            <div class="stepper-nav ps-lg-10">
                                ...
                                <div class="stepper-item" data-kt-stepper-element="nav">
                                    ...
                                    <div class="stepper-label">
                                        <h3 class="stepper-title"><?php echo e(__('setting.Evaluation')); ?></h3>
                                        <div class="stepper-desc"><?php echo e(__('setting.Determine the category distinction')); ?></div>
                                    </div>
                                    <!--نهاية التسمية-->
                                </div>
                                <!--نهاية الخطوة 4-->
                                ...
                                <div data-kt-stepper-element="content">
                                    <div class="w-100">
                                        <div class="fv-row mb-10">
                                            ...
                                            <!--بداية المدخل-->
                                            <div class="mb-4">
                                                <textarea id="description_ar" class="form-control form-control-lg form-control-solid rounded-3 shadow-sm" name="description_ar" rows="4" placeholder="<?php echo e(__('setting.Category Description Arabic')); ?>" required></textarea>
                                            </div>
                                            <!--نهاية المدخل-->
                                        </div>
                                        ...
                                        <div class="fv-row mb-10">
                                            ...
                                            <!--بداية المدخل-->
                                            <div class="mb-4">
                                                <textarea id="description_en" class="form-control form-control-lg form-control-solid rounded-3 shadow-sm" name="description_en" rows="4" placeholder="<?php echo e(__('setting.Category Description English')); ?>" required></textarea>
                                            </div>
                                            <!--نهاية المدخل-->
                                        </div>
                                                    ...
                                                    <?php $__currentLoopData = $category; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <?php if($item['level'] == 2): ?>
                                                            <option value="<?php echo e($item['level']); ?>-<?php echo e($item['id']); ?>"><?php echo e($item['name']); ?>
                                                                ...
                                                                <span><?php echo e(__('setting.Category belongs to')); ?>
                                ...
                                <div data-kt-stepper-element="content">
                                    <div class="w-100 text-center">
                                        ...
                                        <div class="text-center px-4 py-15">
                                            <img src="assets/media/illustrations/sketchy-1/9.png" alt="<?php echo e(__('setting.Release illustration')); ?>" class="mw-100 mh-300px" />
                                        </div>
                                        <!--end::Illustration-->
                                    </div>
                                </div>
...
<script>
    window.translations = {
        ...
        desc: <?php echo json_encode(__('setting.desc'), 15, 512) ?>,
...
<?php echo $__env->make('dashboard.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\answerThem-api-main\resources\views/dashboard/pages/category.blade.php ENDPATH**/ ?>