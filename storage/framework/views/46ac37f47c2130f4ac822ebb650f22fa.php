                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form id="formAddRoles">
                            ...
                            <div class="mb-3">
                                <button type="submit" id="submitRolesAdd" class="btn btn-primary"><?php echo e(__('setting.Submit')); ?></button>
                            </div>
                        </form>
                    </div>
                </div>
...
<?php echo $__env->make('Dashboard.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\answerThem-api-main\resources\views/dashboard/role&permission/role/create.blade.php ENDPATH**/ ?>