                                        ...
                                        <?php $__currentLoopData = $settings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $setting): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <?php switch($setting->type):
                                                case ('string'): ?>
                                                    ...
                                                    <div class="row mb-8">
                                                        <div class="col-xl-3">
                                                            <label class="fs-6 fw-bold mt-2 mb-3"><?php echo e($setting->base_term); ?></label>
                                                        </div>
                                                                    ...
                                                                    <div class="card-body">
                                                                        ...
                                                                        <?php if(!empty($json['name'])): ?>
                                                                            <div class="mb-4">
                                                                                ...
                                                                                <input type="text" class="form-control rounded-3 shadow-sm" name="<?php echo e($setting->id); ?>-<?php echo e($index); ?>-name" value="<?php echo e($json['name']); ?> (<?php echo e($json['code']); ?>)" placeholder="Enter country" required />
                                                                            </div>
                                                                        <?php endif; ?>
