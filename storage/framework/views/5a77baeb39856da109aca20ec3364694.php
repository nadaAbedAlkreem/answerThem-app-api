    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="card">
                <div class="card-body">
                    <h4>Edit
                        <a href="<?php echo e(url('dashboard/permissions/' . request('lang'))); ?>" class="btn btn-danger float-end"><?php echo e(__('setting.Back')); ?></a>
                    </h4>
                </div>
                <div class="card-body">
                    <form id="formUpdatePermission">
                        ...
                        <input type="hidden" name="id" id="id" value="<?php echo e($permission->id); ?>" class="form-control" />
                        ...
                        <div class="mb-3">
                            <button type="submit" id="submitPermission" class="btn btn-primary"><?php echo e(__('setting.Update')); ?></button>
                        </div>
                    </form>
                </div>
            </div>
...
<?php echo $__env->make('dashboard.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\answerThem-api-main\resources\views/dashboard/role&permission/permission/edit.blade.php ENDPATH**/ ?>